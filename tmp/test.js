...
function goodTube_player_selectApi(url: string, reloadVideoData: boolean) {
	...
	if (menu) {
		...
		if (url === 'automatic') {
			...
			let wrapper = document.querySelector('#goodTube_player_wrapper1') as HTMLElement | null;
			...
			let automaticMenuOption = menu.querySelector('ul li:first-child') as HTMLElement | null;
